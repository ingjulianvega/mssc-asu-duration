...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(DurationParameters durationParameters) {
    ...
    public ResponseEntity<ApiError> validationErrorHandler(DurationException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(durationParameters.getApi())
