...
import ingjulianvega.ximic.msscasuduration.configuration.DurationParameters;
...
public class ErrorMessageResolver {
    ...
    private final DurationParameters durationParameters;
    ...
    public ApiError resolveException(final String key) {
        ...
        return ApiError.builder().code(durationParameters.getPrefix() + errorArr[0]).description(errorArr[1]).build();
    }

    private ApiError getApiGenericError() {
        final String message = "UNKNOWN ERROR";
        return ApiError.builder()
                .code(durationParameters.getPrefix() + "500:199")
                .description(message)
                .build();
    }
}
